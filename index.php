...
<?php if (!isset($USER)) { ?>
			...
			<script async src="https://telegram.org/js/telegram-widget.js?7" data-telegram-login="CrushNCTUbot" data-size="large" data-auth-url="https://<?= DOMAIN ?>/login-tg" data-request-access="write"></script>
