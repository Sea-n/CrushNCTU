...
<?php include('includes/nav.php'); ?>
		<header class="ts fluid vertically padded heading slate">
			<div class="ts narrow container">
				<h1 class="ts header">告白交大 2.0</h1>
		...
		<div class="ts container" name="main">
			...
			<div class="icon-row">
				<a id="telegram-icon" class="ts link tiny rounded image" target="_blank" href="https://t.me/CrushNCTU"             ><img src="https://image.flaticon.com/icons/svg/2111/2111646.svg" alt="Telegram" ></a>
				<a id="facebook-icon" class="ts link tiny rounded image" target="_blank" href="https://www.facebook.com/CrushNCTU" ><img src="https://image.flaticon.com/icons/svg/220/220200.svg"   alt="Facebook" ></a>
			</div>

			<h2 class="ts header">審文機制</h2>
			<div id="review-content" style="height: 320px; overflow-y: hidden;">
				<p>新版告白交大 2.0 採自助式審文，所有交大師生皆可加入審核者的行列，以下是系統判斷標準</p>
				<h4>(A) 具名投稿</h4>
...
<?php if (!isset($USER) || !isset($USER['tg_id'])) { ?>
			<script async src="https://telegram.org/js/telegram-widget.js?7" data-telegram-login="CrushNCTUbot" data-size="large" data-auth-url="https://crush.nctu.app/login-tg" data-request-access="write"></script>
<?php } else { ?>
...
<?php } ?>
			...
			<p>感謝您使用「告白交大 2.0」（以下簡稱本網站），本網站之所有文章皆為不特定使用者自行投稿、不特定師生進行審核，並不代表本網站立場。</p>
