...
<?php } ?>
				<div class="content">
					<div itemprop="headline" class="header">#告白交大<?= $id ?></div>
...
if ($post['facebook_id'] > 10) { ?>
					<span><i class="facebook icon"></i> Facebook: <a target="_blank" href="https://www.facebook.com/CrushNCTU/posts/<?= $post['facebook_id'] ?>">@CrushNCTU/<?= $post['facebook_id'] ?></a></span><br>
<?php } ?>
...
<?php } ?>
					...
					<div itemprop="publisher" itemscope itemtype="http://schema.org/Organization" style="display: none;">
						...
						<span itemprop="name">告白交大 2.0</span>
					</div>
